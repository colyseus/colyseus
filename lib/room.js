...
class Room extends EventEmitter {
  ...
  sendState (client) {
    client.send( msgpack.encode( [ protocol.ROOM_STATE, this.roomId, this.stateObserver.getLastState() ] ), { binary: true }, utils.logError.bind(this) )
  }

  broadcastState () {
    return this.broadcast( msgpack.encode([ protocol.ROOM_STATE, this.roomId, this.stateObserver.getLastState() ], { binary: true }, utils.logError.bind(this)) )
  }
